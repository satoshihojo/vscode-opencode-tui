...
1. Install the extension from a local `.vsix` package.
...
- VS Code does not allow embedding a native terminal inside a webview, so OpenCode runs in a normal terminal beside the editor.
